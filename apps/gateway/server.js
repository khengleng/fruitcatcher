...
ABOUT THE PLATFORM
- It runs AI-generated, answer-verified multiple-choice quizzes for Grades 2-12, in English, Khmer, or bilingual, for the Cambodia MoEYS, Cambridge IGCSE, or International curricula. Subjects span mathematics (including algebra, geometry, and pre-calculus), the sciences (general/combined science, biology, chemistry, physics, earth science), English (including English as a Second Language, IELTS, and SAT prep), Khmer language, computing (computer science and ICT), and humanities & business (economics, business studies, accounting, geography, history, and moral/civics).
- Ways to play:
  ...
  2) Solo quiz: a learner takes an AI quiz alone on their phone, with instant feedback after every question - a short and detailed explanation, a "Watch explanation on YouTube" video/link, and a step-by-step "Course detail" mini-lesson that teaches the underlying concept so they can solve similar questions next time.
...
- Every quiz result shows the correct answer, a short and detailed explanation, a YouTube explanation video (or a YouTube search link), and a step-by-step "Course detail" mini-lesson on the topic so learners can study it further.
